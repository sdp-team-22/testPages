...
export class ViewComponent {
    ...
    basicSearch(): void {
        ...
        this.http.get<any>(`https://sdpflaskv2.basicoverflow.com/api/basicSearch?query=${this.searchQuery}`,{ headers }).subscribe(
                (response) => {
    ...
    // Show error message if filters are empty
        ...
        this.http.get<any>(`https://sdpflaskv2.basicoverflow.com/api/advancedSearch?query=${searchQueryString}`, {headers}).subscribe(
            (response) => {
